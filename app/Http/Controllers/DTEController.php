...
//        return response()->json($dte);
        $responseData = $this->SendDTE($dte);
        return response()->json($responseData);
    }

    public
    function comprobanteCCFJson($idVenta)
    {
        $venta = Sale::with('wherehouse', 'wherehouse.economicactivity', 'documenttype', 'seller', 'customer', 'salescondition', 'paymentmethod', 'saleDetails')->find($idVenta);

    }

    function SendDTE($dteData) // Assuming $dteData is the data you need to send
    {
        try {
