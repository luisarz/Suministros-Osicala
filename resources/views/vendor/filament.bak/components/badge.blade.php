    ...
    {{
        $attributes
            ...
            ->class([
                ...
                match ($size) {
                    ActionSize::ExtraSmall => 'px-0.5 min-w-4 tracking-tighter',
                    ActionSize::Small => 'px-1.5 min-w-5 py-0.5 tracking-tight',
                    ActionSize::Medium, ActionSize::Large, ActionSize::ExtraLarge => 'px-2 min-w-6 py-1',
                    default => $size,
                },
                match ($color) {
